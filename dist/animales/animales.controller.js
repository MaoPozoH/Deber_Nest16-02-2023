...
const animales_dto_1 = require("./dto/animales.dto");
let AnimalesController = class AnimalesController {
    constructor(animalesServicio) {
        this.animalesServicio = animalesServicio;
    }
    insertar(animalesDTO) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [animales_dto_1.AnimalesDTO]),
    __metadata("design:returntype", void 0)
], AnimalesController.prototype, "insertar", null);
AnimalesController = __decorate([
    (0, common_1.Controller)('api/v1/animales'),
